    ...
    <section className=" py-10 md:py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-2 md:px-6">
        <div className="text-center mb-16">
          ...
          <h2 className=" md:max-w-4xl mx-auto text-[25px] md:text-4xl lg:text-6xl font-bold text-[#1a202c] mb-6">
            By the numbers: excellence in health
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto md:text-lg leading-relaxed">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center -space-y-10 lg:-space-y-0 lg:-space-x-12 mt-6 md:mt-12">
