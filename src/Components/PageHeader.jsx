  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div className="  bg-[rgb(243,243,255)]   py-20 px-4 rounded-4xl  relative overflow-hidden">
        <h2 className=" text-3xl text-wrap sm:text-6xl font-bold text-[#0b1030] text-center">
          {title}
        </h2>
        <li className="flex flex-wrap items-center justify-center my-8 py-3 mx-auto px-8 bg-indigo-500 text-white rounded-full text-lg font-semibold w-fit">
          <NavLink to="/" className="text-white hover:underline">
            {Link}
          </NavLink>
          <p className="text-nowrap">&nbsp;/ {badge}</p>
        </li>
